...
public class Game {
	...
	public Game(Dice die1, Dice die2, Dice die3) {
		if (die1 == null || die2 == null || die3 == null) throw new IllegalArgumentException("CrownAndAnchorGame.Dice cannot be null.");
	...
	public int playRound(Player player, DiceValue pick, int bet ) {		
		if (player == null) throw new IllegalArgumentException("CrownAndAnchorGame.Player cannot be null.");
